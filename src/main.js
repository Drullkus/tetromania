...
const config = {
    ...
    height: 800,
    useTicker: true,
    scene: [ new Initialize(urlQueryParams.get('mode')), /*PhysicsBox, Rotate, Constraint, Click, Alignment,*/ Credits, MainMenu, PlanetSide, SpaceBackground, Orbit, NavInterface, GameOver ],
    parent: 'tetromania',
